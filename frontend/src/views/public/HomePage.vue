      ...
      <ion-toolbar>
        <div class="max-w-6xl mx-auto px-4 flex items-center justify-between" style="height: 56px;">
          ...
          <div class="flex items-center gap-3">
            <router-link
              to="/notificaciones"
              class="relative p-2 text-[#86868b] hover:text-[#1d1d1f] transition-colors duration-300"
    ...
    <Transition name="slide-up">
      ...
      >
        <div class="bg-white/95 backdrop-blur-xl border-t border-[#e8e8ed] px-4 py-3 flex items-center gap-3 shadow-[0_-4px_24px_rgba(0,0,0,0.08)]">
          ...
          <router-link
            to="/notificaciones"
            class="flex-shrink-0 p-2.5 text-[#86868b] active:text-[#1d1d1f] transition-colors"
          >
