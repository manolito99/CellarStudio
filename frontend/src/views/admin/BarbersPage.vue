      ...
      >
        <div class="flex items-start justify-between mb-4">
          ...
          <div class="flex gap-2">
            <button @click="openModal(barber)" class="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-gray-100 hover:bg-gray-200 text-[#1d1d1f] text-xs font-medium transition-colors">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
              Editar
            </button>
            <button @click="deleteBarber(barber.id)" class="flex items-center gap-1 px-3 py-1.5 rounded-lg text-red-500 hover:bg-red-50 text-xs font-medium transition-colors">
